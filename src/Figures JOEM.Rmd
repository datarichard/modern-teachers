...
#### Figure 3 legend.  
Partial effects of each job component from penalized (smooths) and unpenalized (points) models of teacher mental health, representing sensitivity (in absolute MHI-5 units) of mental health to psychosocial stressors between 2005 and 2022. Shaded regions and vertical lines represent 95 percent confidence intervals.   
